...
[src/data/gyms.ts](src/data/gyms.ts) に静的に保持しています。2026年7月時点で「ラーメン + 各駅」のGoogleマップ検索結果から取得した401店(総武線6駅・東西線6駅・都営新宿線4駅)。閉業表示・非ラーメン店・駅から1.6km超は除外済みです。評価と写真はGoogleマップのもの、徒歩分は駅との直線距離を80m/分で換算した目安です。
